...
--
-- Host: cvmbexdleonetti3.mysql.db
-- Creato il: Mar 17, 2026 alle 09:02
...
CREATE TABLE `assicuratori` (
  `id_ass` int NOT NULL,
  `nome_ag` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `citta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `picf` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
CREATE TABLE `aziende` (
  ...
  `pi` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `ind` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `recapiti` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `email_pg` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `auth_tk` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `prof` int DEFAULT '1',
  `stato` int DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `aziende_pag2` (
  ...
  `ut_api` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `pass_api` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `firma_api` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `accountid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  ...
  `pk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `sk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `wh` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  ...
  `environment` enum('production','sandbox') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'production'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `bagagli` (
  ...
  `dimensione` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '-',
  `cognome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '-',
  `telefono` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `biglietti` (
  ...
  `codice` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `codice_camb` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `transaction_id` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `posto` int DEFAULT '0',
  ...
  `type` int DEFAULT '1',
  `app` int DEFAULT '0',
  `txn_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `biglietti_ipn` (
  ...
  `item_number` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `transaction_id` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `data` datetime DEFAULT '1970-01-01 00:00:00',
  `stato` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `biglietti_log` (
  ...
  `type` int DEFAULT '1',
  `app` int DEFAULT '0',
  `txn_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `attesa` int DEFAULT '0',
  `data` datetime DEFAULT NULL,
  `data2` datetime DEFAULT NULL,
  `acquistato` datetime NOT NULL,
...
CREATE TABLE `biglietti_rit` (
  ...
  `id_bg` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `data` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `corse` (
  ...
  `id_linea` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tempo_acquisto` int DEFAULT '30',
  `gruppo` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'a_1',
  `recapiti` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
CREATE TABLE `corse_liste` (
  `id_csl` int NOT NULL,
  `id_corsa` int NOT NULL,
  `corse` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `stato` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `fermate_data` (
  ...
  `id_sott` int NOT NULL,
  `nome` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
CREATE TABLE `linee` (
  ...
  `colore` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stato` int DEFAULT '1',
  `visualizzato` int DEFAULT '1',
  `id_az` int DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `localita` (
  ...
  `colore` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `stato` int NOT NULL DEFAULT '1',
  `ordine` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `mail_sett` (
  ...
  `user1` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pass1` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `oggetto1` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email2` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user2` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pass2` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `oggetto2` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email3` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user3` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pass3` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `oggetto3` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `smtp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `mezzi` (
  ...
  `nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `targa` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `posti` int DEFAULT '57',
  `anno` date DEFAULT '1970-01-01',
  `foto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `immagine_veicolo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
CREATE TABLE `mezzi_date` (
  ...
  `id_corsa` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `n` int NOT NULL,
  `posti` int DEFAULT '57'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pacchetti` (
  ...
  `giorni_sett` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0,1,2,3,4,5,6',
...
CREATE TABLE `pacchetti_sconti` (
  `id_cod` int NOT NULL,
  `nome` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
--
-- Struttura della tabella `pagamenti_differiti_cicli`
--

CREATE TABLE `pagamenti_differiti_cicli` (
  ...
  `stato` enum('open','pending','overdue','closed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `totale_previsto` decimal(10,2) DEFAULT NULL,
...
--
-- Struttura della tabella `pagamenti_differiti_movimenti`
--

CREATE TABLE `pagamenti_differiti_movimenti` (
  `id_movimento` int UNSIGNED NOT NULL,
  `id_ciclo` int UNSIGNED NOT NULL,
  `id_vg` int NOT NULL,
  `origine` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'biglietto',
  `id_riferimento` int DEFAULT NULL,
  `tabella_riferimento` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `stato` enum('registrato','fatturato','stornato') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'registrato',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Struttura della tabella `pagamenti_differiti_regole`
--

CREATE TABLE `pagamenti_differiti_regole` (
  `id_regola` int UNSIGNED NOT NULL,
  `id_vg` int NOT NULL,
  `frequenza` enum('giornaliera','settimanale','quindicinale','mensile','personalizzata') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mensile',
  `plafond` decimal(10,2) DEFAULT NULL,
  `soglia_avviso` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `payment_errors` (
  ...
  `error_message` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cardholder_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_number_last4` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `provReg` (
  ...
  `provincia` varchar(23) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `regione` varchar(23) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `prz_date` (
  ...
  `da` date NOT NULL,
  `a` date NOT NULL,
  `corsa` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ad` int DEFAULT '1',
  `bam` int DEFAULT '1',
  `stato` int DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pst_date` (
  ...
  `da` date NOT NULL,
  `a` date NOT NULL,
  `corsa` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `posti` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `stato` int DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `regole` (
  ...
  `date_permesse` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `giorni_sett` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `regole_autisti` (
  ...
  `da` date NOT NULL,
  `a` date NOT NULL,
  `corse` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `stato` int NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `regole_corse` (
  `id_rc` int NOT NULL,
  `id_sott` int NOT NULL,
  `corse` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `giorni_sett` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `regole_linee` (
  `id_rl` int NOT NULL,
  `id_linea` int NOT NULL DEFAULT '0',
  `corse` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `da` datetime NOT NULL,
  `a` datetime NOT NULL,
  `giorni_sett` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `regole_tratta` (
  ...
  `corse` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `da` date NOT NULL,
  `a` date NOT NULL,
  `stato` int DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sconti` (
  `id_cod` int NOT NULL,
  `nome` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `codice` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sconto` int DEFAULT '0',
  `partenza` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `scadenza` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `giorni_sett` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  ...
  `ar` int DEFAULT '0',
  `pst` int DEFAULT '57',
  `id_linea` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `id_corsa` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `modific` int NOT NULL DEFAULT '1',
  `avviso` int DEFAULT '0',
  `avviso_str` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stato` int DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tratte_sottoc` (
  `id_sott` int NOT NULL,
  `nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `descsott` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `comune` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provincia` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paese` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_code` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'IT',
  `timezone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Europe/Rome'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `utenti` (
  `id_ut` int NOT NULL,
  `nome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cognome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `citta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `cf` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pass` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `foto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'default.jpg',
  `tel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` date DEFAULT '1970-01-01',
  `stato` int DEFAULT '1',
  `id_vg` int DEFAULT '1',
...
CREATE TABLE `viaggiatori` (
  `id_vg` int NOT NULL,
  `nome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cognome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `citta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `id_prov` int DEFAULT '0',
  `picf` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `pass` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `foto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'default.jpg',
  `tel` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` date DEFAULT '1970-01-01',
  `profilo` int DEFAULT '0',
  `sconto` int DEFAULT '0',
  `tipo_pag` int NOT NULL DEFAULT '0',
  `conteggio_pag` int DEFAULT '1',
  `cadenzaPag` int DEFAULT '0',
  `comunicazioni` int DEFAULT '1',
  `stato` int DEFAULT '1',
  `google_userid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `viaggiatori_mail` (
  ...
  `cognome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '-',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `note` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
CREATE TABLE `viaggiatori_temp` (
  ...
  `cognome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
...
--
-- Indici per le tabelle `pagamenti_differiti_cicli`
--
ALTER TABLE `pagamenti_differiti_cicli`
  ADD PRIMARY KEY (`id_ciclo`),
  ADD KEY `idx_pagamenti_cicli_vg` (`id_vg`),
  ADD KEY `idx_pagamenti_cicli_regola` (`id_regola`),
  ADD KEY `idx_pagamenti_cicli_stato` (`stato`);

--
-- Indici per le tabelle `pagamenti_differiti_movimenti`
--
ALTER TABLE `pagamenti_differiti_movimenti`
  ADD PRIMARY KEY (`id_movimento`),
  ADD KEY `idx_pagamenti_movimenti_ciclo` (`id_ciclo`),
  ADD KEY `idx_pagamenti_movimenti_vg` (`id_vg`),
  ADD KEY `idx_pagamenti_movimenti_stato` (`stato`);

--
-- Indici per le tabelle `pagamenti_differiti_regole`
--
ALTER TABLE `pagamenti_differiti_regole`
  ADD PRIMARY KEY (`id_regola`),
  ADD UNIQUE KEY `uniq_pagamenti_regola_vg` (`id_vg`),
  ADD KEY `idx_pagamenti_regole_stato` (`stato`);
...
--
-- AUTO_INCREMENT per la tabella `pagamenti_differiti_cicli`
--
ALTER TABLE `pagamenti_differiti_cicli`
  MODIFY `id_ciclo` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `pagamenti_differiti_movimenti`
--
ALTER TABLE `pagamenti_differiti_movimenti`
  MODIFY `id_movimento` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `pagamenti_differiti_regole`
--
ALTER TABLE `pagamenti_differiti_regole`
  MODIFY `id_regola` int UNSIGNED NOT NULL AUTO_INCREMENT;

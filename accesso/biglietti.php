...
cvAccessoRenderPageStart('Biglietti', 'tickets', $state);
?>
<div class="row">
    <div class="col-md-12">
        <p class="cv-page-intro">
            Elenco biglietti emessi su Cercaviaggio. Puoi filtrare per provider, ordine, codice ticket, stato pagamento e data acquisto.
        </p>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="cv-panel-card">
                <div class="cv-panel-head">
                    ...
                    <a class="btn btn-default btn-sm" href="<?= cvAccessoH(cvAccessoUrl('biglietti.php') . '?' . $editContextQuery) ?>">
                        Aggiorna
                    </a>
                </div>
                <form method="post" class="cv-form-grid" style="margin-top:12px;">
                    ...
                    <div class="cv-inline-actions">
                        ...
                        <a class="btn btn-default" href="<?= cvAccessoH(cvAccessoUrl('biglietti.php')) ?>">Chiudi modifica</a>
                    </div>
                </form>
            </div>
        </div>
...
<aside id="tickets-filter-drawer" class="cv-side-drawer" aria-hidden="true">
    ...
    <form method="get" class="cv-form-grid">
        ...
        <div class="cv-inline-actions">
            ...
            <a href="<?= cvAccessoH(cvAccessoUrl('biglietti.php')) ?>" class="btn btn-default">Reset</a>
        </div>
    </form>
</aside>
